...
import zxjt.intfc.service.sys.S17GPZDFService;
import zxjt.intfc.test.common.BaseController;

//自己的类名
public class S17GPZDFTest extends BaseController {

	// *自己的Service名称
	@Resource
	private S17GPZDFService systemService;
	...
	public void S17(Map<String, String> param) {
